...
const Skills = () => {
  return (
    <div className="bg-gray-800 flex flex-col gap-6 pt-10">
      <h1 className="sm:text-5xl text-4xl font-medium title-font mb-4 text-white text-center">
        SKILL<span className="text-teal-500">S</span>ET
      </h1>
      <h1 className="sm:text-xl text-lg font-medium title-font mb-4 text-teal-500 text-center">
        MERN STACK
      </h1>
      <div className="flex flex-col md:flex-row items-center justify-center">
        <div>
          <ol className="ml-5 relative border-l border-gray-200 dark:border-gray-700">
            <li className="mb-10 ml-6 hover:bg-gray-900 hover:rounded-xl hover:animate-fall4 p-5">
              <span className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-teal-600">
                <svg
              ...
              <h3 className="ml-8 flex items-center mb-1 text-2xl font-medium text-gray-900 dark:text-white">
                ReactJS &nbsp;&nbsp;&nbsp;
                <FontAwesomeIcon
                  icon={faReact}
                  size="2xl"
        ...
        <div className="mt-10 md:mt-0">
          <ol className="ml-5 mr-5 relative border-l border-gray-200 dark:border-gray-700">
            <li className="mb-10 ml-6 hover:bg-gray-900 hover:rounded-xl hover:animate-fall4 p-5">
              <span className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-teal-600">
                <svg
                  className="w-2.5 h-2.5 text-gray-900 dark:text-white"
            ...
            <li className="mb-10 ml-6 hover:bg-gray-900 hover:rounded-xl hover:animate-fall4 p-5">
              ...
              <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                Over two years of experience with the framework, built over 20 cool frontend projects using ReactJS.
              </p>
            </li>
          </ol>
        </div>
      </div>
      <h3 className="sm:text-small font-medium title-font text-white text-center mt-6">
        I possess proficient expertise in a diverse range of programming languages, including C, C++, Python, Java and JavaScript.
      </h3>
      ...
      <h3 className="sm:text-small font-medium title-font text-white text-center mt-6">
        Experienced in a versatile tech stack, including React, Express.js, Node.js, Tailwind CSS, and Tensorflow.
      </h3>
      <div className="p-6 flex flex-row gap-12 items-center justify-center">
      ...
      <h3 className="sm:text-small font-medium title-font text-white text-center mt-6">
        I am well-versed in utilizing various tools and platforms to enhance the development process, including Visual Studio Code, Cloud Git, Github, Netlify, Vercel, Firebase, and Postman.
      </h3>
      <div className="p-6 flex flex-row gap-12 items-center justify-center">
